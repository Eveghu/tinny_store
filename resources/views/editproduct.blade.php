...
<div class="mb-3">
    ...
    <div class="row">
        ...
        <div class="col-2">
            <div class="form-check">
                <input type="checkbox" name="size[]" class="form-check-input" value="G" id="size" {{ $product->size === 'G' ? 'checked' : '' }}>
        ...
        <div class="col-2">
            ...
            <div class="col-2">
                <div class="form-check">
                    <input type="checkbox" name="size[]" class="form-check-input" value="3" id="size" {{ $product->size === '3' ? 'checked' : '' }}>
